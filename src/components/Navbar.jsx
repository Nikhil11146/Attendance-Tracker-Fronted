                    ...
                    <div className="navbar-auth-links">
                        {isAuthenticated ? (
                            <div className="user-profile-container">
                                ...
                                <button className="profile-btn" onClick={() => navigate('/profile')}><img src="" alt="profile"/></button>
                                <button className="profile-btn" onClick={() => navigate('/settings')}><img src="" alt="settings"/></button>
